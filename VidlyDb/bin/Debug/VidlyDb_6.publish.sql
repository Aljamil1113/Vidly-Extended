...
GO
PRINT N'Creating [dbo].[viewMovieGenre]...';


GO
CREATE VIEW [dbo].[viewMovieGenre]
	AS select [dbo].[Movies].[MovieId], [dbo].[Movies].[Name] as strMovieName, [dbo].[Movies].[ReleaseDate], 
	[dbo].[Movies].[DateAdded], [dbo].[Movies].[NumberInStock], 
	[dbo].[Movies].[GenreId] as intMovieGenreId, [dbo].[Movies].[NumberAvailable], [dbo].[Movies].[Amount], 
	[dbo].[Genres].[GenreId], [dbo].[Genres].[Name] from Movies inner join Genres
...
AS
	select [MovieId], [strMovieName], [ReleaseDate], [DateAdded], [NumberInStock], [intMovieGenreId], 
	[NumberAvailable], [Amount], [GenreId], [Name] from [dbo].[viewMovieGenre]
RETURN 0
GO
