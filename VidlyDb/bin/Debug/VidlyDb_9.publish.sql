...
GO
PRINT N'Altering [dbo].[spShowCustomersWithName]...';


GO
ALTER PROCEDURE [dbo].[spShowCustomersWithName]
	@name nvarchar(50)
AS
...
RETURN 0
GO
PRINT N'Altering [dbo].[spShowMoviesWithName]...';


GO
ALTER PROCEDURE [dbo].[spShowMoviesWithName]
	@name nvarchar(50)
AS
